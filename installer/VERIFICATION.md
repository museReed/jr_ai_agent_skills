...
2. 跑 `./verify.sh --report` 產出診斷報告
3. 修不掉：把「檢查點編號 + 預期 vs 實際 + 報告全文 + 現場證據」整理成 issue 草稿，
   引導用戶貼到 <https://github.com/museReed/jr_ai_agent_skills/issues/new?template=install-report.md>
